...
title: Format
description: Specific details on how to use ucicalendar.com. This includes redirecting to individual calendars and when to include years in your links.
---

export const prerender = false;

import Callout from "../components/Callout.svelte";
import TraceCallout from "../components/TraceCallout.astro";
...
Calendars from 2008 to 2025 are currently available.
...
Calendars from 2015 to 2024 are currently available.
